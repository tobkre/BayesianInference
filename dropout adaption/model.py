...
class ConcreteDropout(nn.Module):
    ...
    def set_p(self, p):
        ...
        self.p_logit = nn.Parameter(torch.empty(1).uniform_(p, p))
        self.p_logit.requires_grad = False
...
#        regularization[4] = self._get_regularization(self.linear4_b1)
    ...
    def set_p(self, p):
        self.conc_drop1.set_p(p)
        self.conc_drop2.set_p(p)
        self.conc_drop3.set_p(p)
        self.conc_drop_b0.set_p(p)
        self.conc_drop_b1.set_p(p)